...
const LEAGUES = {
  ...
  legenden: {
    ...
    clubs: [
      ...
      { slug: "gerd-mueller", name: "Gerd Müller", short: "Gerd Müller", abbr: "GM", colors: ["#DC052D", "#0C1C3D"], file: "gerd-mueller.jpg",
        facts: "Dieser Spieler kommt aus Deutschland und wird „der Bomber der Nation” genannt. Fast seine ganze Karriere spielte er für den FC Bayern München und ist mit 365 Toren bis heute Rekordtorschütze der Bundesliga. Mit Deutschland wurde er 1974 Weltmeister und schoss dabei auch das entscheidende Tor im Finale.",
        factsTts: "Dieser Spieler kommt aus Deutschland und wird der Bomber der Nation genannt. Fast seine ganze Karriere spielte er für den FC Bayern München und ist mit dreihundertfünfundsechzig Toren bis heute Rekordtorschütze der Bundesliga. Mit Deutschland wurde er neunzehnhundertvierundsiebzig Weltmeister und schoss dabei auch das entscheidende Tor im Finale." },
      { slug: "matthaeus", name: "Lothar Matthäus", short: "Lothar Matthäus", abbr: "LM", colors: ["#0C1C3D", "#DD0000"], file: "matthaeus.jpg",
        facts: "Dieser Spieler kommt aus Deutschland und ist mit 150 Länderspielen Rekordnationalspieler der deutschen Fußball-Nationalmannschaft. Er spielte unter anderem für den FC Bayern München und Inter Mailand. Als Kapitän führte er Deutschland 1990 zum Weltmeistertitel.",
        factsTts: "Dieser Spieler kommt aus Deutschland und ist mit hundertfünfzig Länderspielen Rekordnationalspieler der deutschen Fußball-Nationalmannschaft. Er spielte unter anderem für den FC Bayern München und Inter Mailand. Als Kapitän führte er Deutschland neunzehnhundertneunzig zum Weltmeistertitel." },
      { slug: "kroos", name: "Toni Kroos", short: "Toni Kroos", abbr: "TK", colors: ["#0C1C3D", "#DD0000"], file: "kroos.jpg",
        facts: "Dieser Spieler kommt aus Deutschland und ist bekannt für sein präzises Passspiel. Er begann seine Karriere beim FC Bayern München und gewann später mit Real Madrid fünfmal die Champions League. Mit Deutschland wurde er 2014 Weltmeister.",
        factsTts: "Dieser Spieler kommt aus Deutschland und ist bekannt für sein präzises Passspiel. Er begann seine Karriere beim FC Bayern München und gewann später mit Real Madrid fünfmal die Champions League. Mit Deutschland wurde er zweitausendvierzehn Weltmeister." },
      { slug: "thomas-mueller", name: "Thomas Müller", short: "Thomas Müller", abbr: "TM", colors: ["#DC052D", "#0C1C3D"], file: "thomas-mueller.jpg",
        facts: "Dieser Spieler kommt aus Deutschland und spielte seine gesamte Karriere für den FC Bayern München. Wegen seines besonderen Gespürs für freie Räume wird er auch „Raumdeuter” genannt. Mit Deutschland wurde er 2014 Weltmeister.",
        factsTts: "Dieser Spieler kommt aus Deutschland und spielte seine gesamte Karriere für den FC Bayern München. Wegen seines besonderen Gespürs für freie Räume wird er auch Raumdeuter genannt. Mit Deutschland wurde er zweitausendvierzehn Weltmeister." },
      { slug: "zidane", name: "Zinedine Zidane", short: "Zinedine Zidane", abbr: "ZZ", colors: ["#002654", "#ED2939"], file: "zidane.jpg",
        facts: "Dieser Spieler kommt aus Frankreich und gilt als einer der elegantesten Fußballer aller Zeiten. Er spielte unter anderem für Juventus Turin und Real Madrid. Mit Frankreich wurde er 1998 Weltmeister und erzielte im Finale zwei Kopfballtore.",
        factsTts: "Dieser Spieler kommt aus Frankreich und gilt als einer der elegantesten Fußballer aller Zeiten. Er spielte unter anderem für Juventus Turin und Real Madrid. Mit Frankreich wurde er neunzehnhundertachtundneunzig Weltmeister und erzielte im Finale zwei Kopfballtore." },
      { slug: "ibrahimovic", name: "Zlatan Ibrahimović", short: "Zlatan Ibrahimović", abbr: "ZI", colors: ["#006AA7", "#FECC02"], file: "ibrahimovic.jpg",
        facts: "Dieser Spieler kommt aus Schweden und ist berühmt für spektakuläre Fallrückzieher-Tore. Er spielte für viele große Vereine wie Ajax Amsterdam, Inter Mailand, den FC Barcelona, Paris Saint-Germain und den AC Mailand. Mit Schweden nahm er mehrfach an Europameisterschaften teil.",
        factsTts: "Dieser Spieler kommt aus Schweden und ist berühmt für spektakuläre Fallrückzieher-Tore. Er spielte für viele große Vereine wie Ajax Amsterdam, Inter Mailand, den FC Barcelona, Paris Saint-Germain und den AC Mailand. Mit Schweden nahm er mehrfach an Europameisterschaften teil." },
      { slug: "totti", name: "Francesco Totti", short: "Francesco Totti", abbr: "FT", colors: ["#0066CC", "#FFFFFF"], file: "totti.jpg",
        facts: "Dieser Spieler kommt aus Italien und blieb sein ganzes Leben lang bei einem einzigen Verein: dem AS Rom, für den er von 1993 bis 2017 spielte. Als Kapitän führte er den Club 2001 zur italienischen Meisterschaft. Mit Italien wurde er 2006 Weltmeister.",
        factsTts: "Dieser Spieler kommt aus Italien und blieb sein ganzes Leben lang bei einem einzigen Verein: dem AS Rom, für den er von neunzehnhundertdreiundneunzig bis zweitausendsiebzehn spielte. Als Kapitän führte er den Club zweitausendeins zur italienischen Meisterschaft. Mit Italien wurde er zweitausendsechs Weltmeister." },
      { slug: "pirlo", name: "Andrea Pirlo", short: "Andrea Pirlo", abbr: "AP", colors: ["#0066CC", "#FFFFFF"], file: "pirlo.jpg",
        facts: "Dieser Spieler kommt aus Italien und war berühmt für seine präzisen Pässe und sein ruhiges Spiel im Mittelfeld. Er spielte unter anderem für den AC Mailand und Juventus Turin. Mit Italien wurde er 2006 Weltmeister.",
        factsTts: "Dieser Spieler kommt aus Italien und war berühmt für seine präzisen Pässe und sein ruhiges Spiel im Mittelfeld. Er spielte unter anderem für den AC Mailand und Juventus Turin. Mit Italien wurde er zweitausendsechs Weltmeister." },
      { slug: "roberto-carlos", name: "Roberto Carlos", short: "Roberto Carlos", abbr: "RC", colors: ["#FCDF00", "#009739"], file: "roberto-carlos.jpg",
        facts: "Dieser Spieler kommt aus Brasilien und ist berühmt für seine extrem harten und stark gekrümmten Freistöße. Fast seine ganze Karriere spielte er für Real Madrid. Mit Brasilien wurde er 2002 Weltmeister.",
        factsTts: "Dieser Spieler kommt aus Brasilien und ist berühmt für seine extrem harten und stark gekrümmten Freistöße. Fast seine ganze Karriere spielte er für Real Madrid. Mit Brasilien wurde er zweitausendzwei Weltmeister." },
      { slug: "voeller", name: "Rudi Völler", short: "Rudi Völler", abbr: "RV", colors: ["#0C1C3D", "#DD0000"], file: "voeller.jpg",
        facts: "Dieser Spieler kommt aus Deutschland und ist an seiner markanten Dauerwelle und seinem Schnauzbart zu erkennen. Er spielte unter anderem für Bayer 04 Leverkusen, AS Rom und Olympique Marseille. Mit Deutschland wurde er 1990 Weltmeister.",
        factsTts: "Dieser Spieler kommt aus Deutschland und ist an seiner markanten Dauerwelle und seinem Schnauzbart zu erkennen. Er spielte unter anderem für Bayer null vier Leverkusen, AS Rom und Olympique Marseille. Mit Deutschland wurde er neunzehnhundertneunzig Weltmeister." },
      { slug: "ronaldo-nazario", name: "Ronaldo Nazário", short: "Ronaldo Nazário", abbr: "R9", colors: ["#FCDF00", "#009739"], file: "ronaldo-nazario.jpg",
        facts: "Dieser Spieler kommt aus Brasilien und wird auch „der Phänomen” genannt. Er spielte unter anderem für PSV Eindhoven, den FC Barcelona, Inter Mailand und Real Madrid. Mit Brasilien wurde er 2002 Weltmeister und war mit acht Toren bester Torschütze des Turniers.",
        factsTts: "Dieser Spieler kommt aus Brasilien und wird auch der Phänomen genannt. Er spielte unter anderem für PSV Eindhoven, den FC Barcelona, Inter Mailand und Real Madrid. Mit Brasilien wurde er zweitausendzwei Weltmeister und war mit acht Toren bester Torschütze des Turniers." },
      { slug: "maldini", name: "Paolo Maldini", short: "Paolo Maldini", abbr: "PM", colors: ["#0066CC", "#FFFFFF"], file: "maldini.jpg",
        facts: "Dieser Spieler kommt aus Italien und spielte seine gesamte 25 Jahre lange Karriere für den AC Mailand. Als Kapitän gewann er 2007 im Alter von 38 Jahren noch einmal die Champions League. Mit Italien stand er 1994 im WM-Finale.",
        factsTts: "Dieser Spieler kommt aus Italien und spielte seine gesamte fünfundzwanzig Jahre lange Karriere für den AC Mailand. Als Kapitän gewann er zweitausendsieben im Alter von achtunddreißig Jahren noch einmal die Champions League. Mit Italien stand er neunzehnhundertvierundneunzig im WM-Finale." },
      { slug: "nesta", name: "Alessandro Nesta", short: "Alessandro Nesta", abbr: "AN", colors: ["#0066CC", "#FFFFFF"], file: "nesta.jpg",
        facts: "Dieser Spieler kommt aus Italien und gilt als einer der besten Innenverteidiger seiner Generation. Er spielte für Lazio Rom und den AC Mailand. Mit Italien wurde er 2006 Weltmeister.",
        factsTts: "Dieser Spieler kommt aus Italien und gilt als einer der besten Innenverteidiger seiner Generation. Er spielte für Lazio Rom und den AC Mailand. Mit Italien wurde er zweitausendsechs Weltmeister." },
      { slug: "del-piero", name: "Alessandro Del Piero", short: "Alessandro Del Piero", abbr: "ADP", colors: ["#0066CC", "#FFFFFF"], file: "del-piero.jpg",
        facts: "Dieser Spieler kommt aus Italien und spielte 19 Jahre lang für Juventus Turin, für die er mehr Tore erzielte als jeder andere Spieler. Seine Tore aus dem spitzen Winkel wurden so berühmt, dass diese Ecke des Strafraums „Zona Del Piero” genannt wird. Mit Italien wurde er 2006 Weltmeister.",
        factsTts: "Dieser Spieler kommt aus Italien und spielte neunzehn Jahre lang für Juventus Turin, für die er mehr Tore erzielte als jeder andere Spieler. Seine Tore aus dem spitzen Winkel wurden so berühmt, dass diese Ecke des Strafraums Zona Del Piero genannt wird. Mit Italien wurde er zweitausendsechs Weltmeister." },
    ]
  }
};
