  ...
  legenden: {
    ...
    clubs: [
      { slug: "beckenbauer", name: "Franz Beckenbauer", short: "Franz Beckenbauer", abbr: "FB", colors: ["#DC052D", "#0C1C3D"], file: "beckenbauer.png",
        ...
        factsTts: "Dieser Spieler kommt aus Deutschland und wird „der Kaiser” genannt. Er spielte fast seine ganze Karriere für den FC Bayern München und wurde neunzehnhundertvierundsiebzig mit Deutschland als Kapitän Weltmeister. Als Trainer gewann er den Titel neunzehnhundertneunzig sogar noch einmal." },
      { slug: "pele", name: "Pelé", short: "Pelé", abbr: "P", colors: ["#FCDF00", "#009739"], file: "pele.png",
        ...
        factsTts: "Dieser Spieler kommt aus Brasilien und gilt für viele als der beste Fußballer aller Zeiten. Fast seine ganze Karriere spielte er für den Verein FC Santos. Mit Brasilien wurde er dreimal Weltmeister: neunzehnhundertachtundfünfzig, neunzehnhundertzweiundsechzig und neunzehnhundertsiebzig." },
      { slug: "ronaldinho", name: "Ronaldinho", short: "Ronaldinho", abbr: "R10", colors: ["#A50044", "#004D98"], file: "ronaldinho.png",
        ...
        factsTts: "Dieser Spieler kommt aus Brasilien und ist berühmt für seine Tricks und sein Lächeln auf dem Platz. Er spielte unter anderem für den FC Barcelona. Mit Brasilien wurde er zweitausendzwei Weltmeister, und zweitausendfünf wurde er zum besten Fußballer der Welt gewählt." },
      { slug: "walter", name: "Fritz Walter", short: "Fritz Walter", abbr: "FW", colors: ["#DD0000", "#000000"], file: "walter.webp",
        ...
        factsTts: "Dieser Spieler kommt aus Deutschland und blieb sein ganzes Leben lang bei einem einzigen Verein: dem Ersten FC Kaiserslautern. Als Kapitän führte er die deutsche Nationalmannschaft neunzehnhundertvierundfünfzig zum ersten deutschen Weltmeistertitel, dem berühmten „Wunder von Bern”." },
      { slug: "klose", name: "Miroslav Klose", short: "Miroslav Klose", abbr: "MK", colors: ["#0C1C3D", "#DD0000"], file: "klose.png",
        facts: "Dieser Spieler kommt aus Deutschland und war mit 16 Toren von 2014 bis 2026 Rekordtorschütze der Fußball-Weltmeisterschaften, bis Lionel Messi ihn 2026 überholte. Seine Karriere begann er beim 1. FC Kaiserslautern, später spielte er unter anderem für Werder Bremen und den FC Bayern München. Mit Deutschland wurde er 2014 Weltmeister.",
        factsTts: "Dieser Spieler kommt aus Deutschland und war mit sechzehn Toren von zweitausendvierzehn bis zweitausendsechsundzwanzig Rekordtorschütze der Fußball-Weltmeisterschaften, bis Lionel Messi ihn zweitausendsechsundzwanzig überholte. Seine Karriere begann er beim Ersten FC Kaiserslautern, später spielte er unter anderem für Werder Bremen und den FC Bayern München. Mit Deutschland wurde er zweitausendvierzehn Weltmeister." },
      { slug: "messi", name: "Lionel Messi", short: "Lionel Messi", abbr: "M10", colors: ["#75AADB", "#FFFFFF"], file: "messi.webp",
        ...
        factsTts: "Dieser Spieler kommt aus Argentinien und gewann den Ballon d'Or, die Auszeichnung für den besten Fußballer der Welt, rekordverdächtige achtmal. Fast seine ganze Karriere spielte er für den FC Barcelona. Mit Argentinien wurde er zweitausendzweiundzwanzig endlich Weltmeister." },
      { slug: "ronaldo", name: "Cristiano Ronaldo", short: "Cristiano Ronaldo", abbr: "CR7", colors: ["#FF0000", "#046A38"], file: "ronaldo.png",
        ...
        factsTts: "Dieser Spieler kommt aus Portugal und gewann den Ballon d'Or fünfmal. Er spielte unter anderem für Manchester United, Real Madrid und Juventus Turin und wurde fünfmal Champions-League-Sieger. Mit Portugal gewann er zweitausendsechzehn die Europameisterschaft." },
      { slug: "beckham", name: "David Beckham", short: "David Beckham", abbr: "DB7", colors: ["#0033A0", "#DA291C"], file: "beckham.png",
        ...
        factsTts: "Dieser Spieler kommt aus England und ist berühmt für seine präzisen Freistöße und Flanken. Er spielte unter anderem für Manchester United und Real Madrid und gewann neunzehnhundertneunundneunzig mit Manchester United gleich drei große Titel in einem Jahr." },
      { slug: "buffon", name: "Gianluigi Buffon", short: "Gianluigi Buffon", abbr: "GB", colors: ["#0066CC", "#FFFFFF"], file: "buffon.webp",
        ...
        factsTts: "Dieser Spieler kommt aus Italien und war einer der besten Torhüter der Fußballgeschichte. Fast seine gesamte Karriere spielte er für Juventus Turin. Mit Italien wurde er zweitausendsechs Weltmeister." },
      { slug: "maradona", name: "Diego Maradona", short: "Diego Maradona", abbr: "DM", colors: ["#75AADB", "#FFFFFF"], file: "maradona.png",
        ...
        // Anführungszeichen um "Jahrhunderttor" führten in Tests zu akustischen
        // Ausssetzern – für die Sprachausgabe deshalb ohne Anführungszeichen.
        factsTts: "Dieser Spieler kommt aus Argentinien und gilt für viele als einer der größten Fußballer aller Zeiten. Er spielte unter anderem für den FC Barcelona und den SSC Neapel. Mit Argentinien wurde er neunzehnhundertsechsundachtzig Weltmeister und schoss dabei das berühmte Jahrhunderttor gegen England." },
    ]
  }
};
